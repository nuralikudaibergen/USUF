...
export function ShoesPage() {
  ...
  const items = products.filter((p) => p.type === "footwear")
    ...
    <div className="bg-forest-deep">
      <section className="relative overflow-hidden border-b border-gold/20">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 70% 30%, rgba(232,160,32,0.18) 0%, transparent 60%), linear-gradient(180deg, #0F2A1F 0%, #1B4332 100%)",
          }}
        />
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-20 md:grid-cols-2 md:py-28">
          <div>
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-gold-soft/80">
              Премиальная кожа, итальянское качество, продуманная колодка. Туфли и кеды, которые
              становятся только лучше со временем.
            </p>
